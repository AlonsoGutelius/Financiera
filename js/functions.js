function LiquidezGeneral(){
    ...
    function IndiceLiquidez(){
        ...
        var num1=Number(document.getElementById('ActivoDis').value);
        var num2=Number(document.getElementById('PasivoCorr').value);
        var res=num1/num2;
        res = res.toFixed(2);
        document.getElementById('IL').value=res;
    }
    ...
    function RentabilidadVentas(){
        ...
        var num2=Number(document.getElementById('ventasNetasR').value);
        var respu= (num1/num2)*100;
        respu = respu.toFixed(2);
        document.getElementById('RENV').value=respu+"%";
    }
